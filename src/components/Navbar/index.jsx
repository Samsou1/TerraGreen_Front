    ...
    <header>
      ...
      <nav>
        ...
        <div onClick={toggleNav} className={toggleMenu ? "plate active" : "plate"}>
          <svg className="toggle-button burger" version="1.1" height="100" width="100" viewBox="0 0 100 100">
          ...
          <svg className="toggle-button x" version="1.1" height="100" width="100" viewBox="0 0 100 100">
